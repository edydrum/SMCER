...
app.controller('AuthCtrl', ["$rootScope", "$scope", "$state", "$localStorage", "ValidatorService", "Auth","SweetAlert", function ($rootScope, $scope, $state, $localStorage, ValidatorService, Auth, SweetAlert) {
